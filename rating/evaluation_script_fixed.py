...
def main():
    ...
    print(f"结果已保存至: final_evaluation_results.csv")
    print(f"{'='*60}\n")
    ...
    if not df_judge.empty:
        ...
        plt.tight_layout()
        plt.savefig("chart_comprehensiveness.png", dpi=300)
        print("✓ 图表已生成: chart_comprehensiveness.png")
        ...
        plt.legend(title="Type")
        plt.tight_layout()
        plt.savefig("chart_faithfulness.png", dpi=300)
        print("✓ 图表已生成: chart_faithfulness.png")
        ...
        plt.legend(title="Type")
        plt.tight_layout()
        plt.savefig("chart_relevance.png", dpi=300)
        print("✓ 图表已生成: chart_relevance.png")
